...
install("session");                                                                                                    // 66
install("jquery", "meteor/jquery/main.js");                                                                            // 67
...
install("ui");                                                                                                         // 86
install("momentjs:moment");                                                                                            // 87
install("aldeed:autoform");                                                                                            // 88
install("sacha:spin");                                                                                                 // 89
...
install("less");                                                                                                       // 98
install("accounts-ui-unstyled");                                                                                       // 99
install("accounts-ui");                                                                                                // 100
install("kadira:flow-router");                                                                                         // 101
install("coffeescript");                                                                                               // 102
install("zimme:active-route");                                                                                         // 103
install("kadira:blaze-layout");                                                                                        // 104
install("arillo:flow-router-helpers");                                                                                 // 105
install("semantic:ui");                                                                                                // 106
install("juliancwirko:postcss");                                                                                       // 107
install("fabienb4:autoform-semantic-ui");                                                                              // 108
install("autopublish");                                                                                                // 109
install("webapp");                                                                                                     // 110
install("hot-code-push");                                                                                              // 111
install("launch-screen");                                                                                              // 112
install("autoupdate");                                                                                                 // 113
install("mdg:validation-error");                                                                                       // 114
                                                                                                                       // 115
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
