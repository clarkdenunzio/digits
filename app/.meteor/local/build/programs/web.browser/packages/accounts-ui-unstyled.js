...
Template["_loginButtonsLoggedOutSingleLoginButton"] = new Template("Template._loginButtonsLoggedOutSingleLoginButton", (function() {
  ...
  return HTML.DIV({                                                                                                    // 5
    ...
    return Spacebars.call(view.lookup("cannotConfigure"));                                                             // 19
  }, function() {                                                                                                      // 20
    return [ "\n        ", HTML.SPAN({                                                                                 // 21
      class: ""                                                                                                        // 22
    }, Blaze.View("lookup:capitalizedName", function() {                                                               // 23
      return Spacebars.mustache(view.lookup("capitalizedName"));                                                       // 24
    }), " not configured"), "\n      " ];                                                                              // 25
  }, function() {                                                                                                      // 26
    return [ "\n        ", HTML.DIV({                                                                                  // 27
      class: "login-image",                                                                                            // 28
      id: function() {                                                                                                 // 29
        return [ "login-buttons-image-", Spacebars.mustache(view.lookup("name")) ];                                    // 30
      }                                                                                                                // 31
    }), "\n        ", Blaze.If(function() {                                                                            // 32
      return Spacebars.call(view.lookup("configured"));                                                                // 33
    }, function() {                                                                                                    // 34
      return [ "\n          ", HTML.SPAN({                                                                             // 35
        class: function() {                                                                                            // 36
          return [ "text-besides-image sign-in-text-", Spacebars.mustache(view.lookup("name")) ];                      // 37
        }                                                                                                              // 38
      }, "Sign in with ", Blaze.View("lookup:capitalizedName", function() {                                            // 39
        return Spacebars.mustache(view.lookup("capitalizedName"));                                                     // 40
      })), "\n        " ];                                                                                             // 41
    }, function() {                                                                                                    // 42
      return [ "\n            ", HTML.SPAN({                                                                           // 43
        class: function() {                                                                                            // 44
          return [ "text-besides-image configure-text-", Spacebars.mustache(view.lookup("name")) ];                    // 45
        }                                                                                                              // 46
      }, "Configure ", Blaze.View("lookup:capitalizedName", function() {                                               // 47
        return Spacebars.mustache(view.lookup("capitalizedName"));                                                     // 48
      }), " Login"), "\n        " ];                                                                                   // 49
    }), "\n      " ];                                                                                                  // 50
  }), "\n    "), "\n  ");                                                                                              // 51
}));                                                                                                                   // 52
                                                                                                                       // 53
Template.__checkName("_loginButtonsLoggingInSingleLoginButton");                                                       // 54
Template["_loginButtonsLoggingInSingleLoginButton"] = new Template("Template._loginButtonsLoggingInSingleLoginButton", (function() {
  var view = this;                                                                                                     // 56
  return HTML.DIV({                                                                                                    // 57
    class: "login-text-and-button"                                                                                     // 58
  }, "\n    ", Spacebars.include(view.lookupTemplate("_loginButtonsLoggingIn")), "\n  ");                              // 59
}));                                                                                                                   // 60
                                                                                                                       // 61
Template.__checkName("_loginButtonsLoggedInSingleLogoutButton");                                                       // 62
Template["_loginButtonsLoggedInSingleLogoutButton"] = new Template("Template._loginButtonsLoggedInSingleLogoutButton", (function() {
  var view = this;                                                                                                     // 64
  return HTML.DIV({                                                                                                    // 65
    class: "login-text-and-button"                                                                                     // 66
  }, "\n    ", HTML.DIV({                                                                                              // 67
    class: "login-display-name"                                                                                        // 68
  }, "\n      ", Blaze.View("lookup:displayName", function() {                                                         // 69
    return Spacebars.mustache(view.lookup("displayName"));                                                             // 70
...
var loginResultCallback = function (serviceName, err) {                                                                // 5
  if (!err) {                                                                                                          // 6
    ...
    if (Template._configureLoginServiceDialog.templateForService(serviceName)) {                                       // 11
      loginButtonsSession.configureService(serviceName);                                                               // 12
    } else {                                                                                                           // 13
      loginButtonsSession.errorMessage(                                                                                // 14
        "No configuration for " + capitalize(serviceName) + ".\n" +                                                    // 15
        "Use `ServiceConfiguration` to configure it or " +                                                             // 16
        "install the `" +serviceName + "-config-ui` package."                                                          // 17
      );                                                                                                               // 18
    }                                                                                                                  // 19
  } else {                                                                                                             // 20
    loginButtonsSession.errorMessage(err.reason || "Unknown error");                                                   // 21
  }                                                                                                                    // 22
};                                                                                                                     // 23
                                                                                                                       // 24
                                                                                                                       // 25
// In the login redirect flow, we'll have the result of the login                                                      // 26
// attempt at page load time when we're redirected back to the                                                         // 27
// application.  Register a callback to update the UI (i.e. to close                                                   // 28
// the dialog on a successful login or display the error on a failed                                                   // 29
// login).                                                                                                             // 30
//                                                                                                                     // 31
Accounts.onPageLoadLogin(function (attemptInfo) {                                                                      // 32
  // Ignore if we have a left over login attempt for a service that is no longer registered.                           // 33
  if (_.contains(_.pluck(getLoginServices(), "name"), attemptInfo.type))                                               // 34
    loginResultCallback(attemptInfo.type, attemptInfo.error);                                                          // 35
});                                                                                                                    // 36
                                                                                                                       // 37
                                                                                                                       // 38
Template._loginButtonsLoggedOutSingleLoginButton.events({                                                              // 39
  'click .login-button': function () {                                                                                 // 40
    var serviceName = this.name;                                                                                       // 41
    loginButtonsSession.resetMessages();                                                                               // 42
                                                                                                                       // 43
    // XXX Service providers should be able to specify their                                                           // 44
    // `Meteor.loginWithX` method name.                                                                                // 45
    var loginWithService = Meteor["loginWith" +                                                                        // 46
                                  (serviceName === 'meteor-developer' ?                                                // 47
                                   'MeteorDeveloperAccount' :                                                          // 48
                                   capitalize(serviceName))];                                                          // 49
                                                                                                                       // 50
    var options = {}; // use default scope unless specified                                                            // 51
    if (Accounts.ui._options.requestPermissions[serviceName])                                                          // 52
      options.requestPermissions = Accounts.ui._options.requestPermissions[serviceName];                               // 53
    if (Accounts.ui._options.requestOfflineToken[serviceName])                                                         // 54
      options.requestOfflineToken = Accounts.ui._options.requestOfflineToken[serviceName];                             // 55
    if (Accounts.ui._options.forceApprovalPrompt[serviceName])                                                         // 56
      options.forceApprovalPrompt = Accounts.ui._options.forceApprovalPrompt[serviceName];                             // 57
                                                                                                                       // 58
    loginWithService(options, function (err) {                                                                         // 59
      loginResultCallback(serviceName, err);                                                                           // 60
    });                                                                                                                // 61
  }                                                                                                                    // 62
});                                                                                                                    // 63
                                                                                                                       // 64
Template._loginButtonsLoggedOutSingleLoginButton.helpers({                                                             // 65
  // not configured and has no config UI                                                                               // 66
  cannotConfigure: function() {                                                                                        // 67
    return !ServiceConfiguration.configurations.findOne({service: this.name})                                          // 68
      && !Template._configureLoginServiceDialog.templateForService(this.name);                                         // 69
  },                                                                                                                   // 70
  configured: function () {                                                                                            // 71
    return !!ServiceConfiguration.configurations.findOne({service: this.name});                                        // 72
  },                                                                                                                   // 73
  capitalizedName: function () {                                                                                       // 74
    if (this.name === 'github')                                                                                        // 75
      // XXX we should allow service packages to set their capitalized name                                            // 76
      return 'GitHub';                                                                                                 // 77
    else if (this.name === 'meteor-developer')                                                                         // 78
      return 'Meteor';                                                                                                 // 79
    else                                                                                                               // 80
      return capitalize(this.name);                                                                                    // 81
  }                                                                                                                    // 82
});                                                                                                                    // 83
                                                                                                                       // 84
// XXX from http://epeli.github.com/underscore.string/lib/underscore.string.js                                         // 85
var capitalize = function(str){                                                                                        // 86
  str = str == null ? '' : String(str);                                                                                // 87
  return str.charAt(0).toUpperCase() + str.slice(1);                                                                   // 88
};                                                                                                                     // 89
                                                                                                                       // 90
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Template._configureLoginServiceDialog.templateForService = function(serviceName) {                                     // 240
  serviceName = serviceName || loginButtonsSession.get('configureLoginServiceDialogServiceName');                      // 241
...
var configurationFields = function () {                                                                                // 250
  var template = Template._configureLoginServiceDialog.templateForService();                                           // 251
...
Template._configureLoginServiceDialog.helpers({                                                                        // 255
  ...
  configurationSteps: function () {                                                                                    // 262
    ...
    return Template._configureLoginServiceDialog.templateForService();                                                 // 264
  },                                                                                                                   // 265
